...
<img src="/images/fluidzero-thumbnail.jpg" alt="FluidZero thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/recent-advances-thumbnail.jpg" alt="ML for CFD Survey thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/wavelet-dno-thumbnail.jpg" alt="Wavelet Diffusion Neural Operator thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/cl-diffphycon-thumbnail.jpg" alt="CL-DiffPhyCon thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/diffphycon-thumbnail.jpg" alt="DiffPhyCon thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/generative-pde-control-thumbnail.jpg" alt="Generative PDE Control thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/compositional-generative-inverse-design-thumbnail.jpg" alt="Compositional Generative Inverse Design thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
...
<img src="/images/sif-thumbnail.jpg" alt="SIF thumbnail" style="float: left; margin-right: 20px; width: 150px; height: auto; margin-bottom: 20px;">  
